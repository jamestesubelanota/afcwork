...
class CabeceraMovimiento extends Model
{
    ...
    public static function boot(){
        ...
        static::deleted(function($movimiento) {
            ...
            Logmovimientos::create([
                'id_cabecera' => $movimiento->getOriginal('id_cabecera'),
                'id_cliente' => $movimiento->getOriginal('id_cliente'),
                'id_sede' => $movimiento->getOriginal('id_sede'),
                'usuario' => Auth::user()->name,
                'detalle' => $movimiento->getOriginal('detalle'),
                'accion'=> 'insert',
                'id_tmovimiento'  => $movimiento->getOriginal('id_tmovimiento')
            ]);
        });
