...
<br>
<span style="color: red">@error('tipo_de_contrato') {{$message}}
    
@enderror</span>
<input type="text" id="tipo_de_contrato"  name ="tipo_de_contrato" class="form-control" value="{{$contrato->tipo_de_contrato}}"  >
<br>
...
<br>
<span style="color: red">@error('fin') {{$message}}
