                                ...
                                <div class="p-6 bg-white border-b border-gray-200">
                                    <form action="   {{ route('activos.update', $activo) }}" method="POST"
                                        ...
                                        <span style="color: red"> @error('foto')
                                                {{ $message }}
                                            @enderror </span>
                                        <input value="{{ old('foto') }}" class="form-control" type="file"
                                        ...
                                        <input type="date" id="ffechaDeCompra" name="fechaDeCompra" class="form-control"
                                            value="{{ $activo->fechaDeCompra }}">
                                        <br>
                                        <!--INICIO IMPUT  EQUIPO -->
                                        ...
                                        <select class="form-select" id="equipo" name="equipo">
                                            ...
                                            @foreach ($equipos as $equipo)
                                                @if (old('equipo') == $equipo->id_equipo)
                                                    <option value="{{ $equipo->id_equipo }}" selected>
                                                        {{ $equipo->equipo }}</option>
                                                @else
                                                    <option value="{{ $equipo->id_equipo }}"> {{ $equipo->equipo }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        ...
                                        <select class="form-select" id="propietario" name="propietario">
                                            ...
                                            @foreach ($propietario as $propietario)
                                                @if (old('propietario') == $propietario->id_propietario)
                                                    <option value="{{ $propietario->id_propietario }}" selected>
                                                        {{ $propietario->nombre_propietario }}</option>
                                                @else
                                        ...
                                        <select class="form-select" id="tipo_de_equipo" name="tipo_de_equipo">
                                            ...
                                            @foreach ($tipoEquipo as $tipoEquipos)
                                                @if (old('tipo_de_equipo') == $tipoEquipos->id_equipo)
                                                    <option value="{{ $tipoEquipos->id_equipo }}" selected>
                                                        {{ $tipoEquipos->tipo_de_equipo }}</option>
                                                @else
                                                    <option value="{{ $tipoEquipos->id_equipo }}">
                                                        {{ $tipoEquipos->tipo_de_equipo }}</option>
                                                @endif
                                            @endforeach
                                        ...
                                        value="{{ old('cliente', $activo->cliente->nombre_cliente) }}">
                                        ...
                                        value="{{ old('sede', $activo->sede->nombre_sede) }}">
                                        ...
                                        <div>
                                            <a class="px-4 py-2 text-white bg-gray-800 rounded"
                                                href="{{ route('activos.index') }}">volver</a>
