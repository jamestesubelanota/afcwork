...
@enderror</span>
<input type="text" id="nombre_sede"  name ="nombre_sede" class="form-control" value="{{ old('nombre_sede',$sede->nombre_sede ) }}"  >
...
@enderror</span>
<input type="text" id="direccion" name ="direccion" class="form-control" value="{{old('direccion', $sede->direccion) }}"  >
...
@enderror</span>
<input type="text" id="contacto	" name ="contacto" class="form-control" value="{{ old('contacto', $sede->contacto) }}"  >
<label class="form-label" >Telefono</label>
<br>
<span> @error('telefono') {{$message}}
    
@enderror</span>
<input type="text" id="telefono" name ="telefono" class="form-control" value="{{ old( 'telefono',$sede->telefono)}}"  >
<br>
