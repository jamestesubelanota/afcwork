    ...
    <x-app-layout>
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Roles') }}
                <a class="bg-gray-800 text-white rounded px-4 py-2" href="{{ route('roles.create') }}"> crear</a>
            </h2>
        </x-slot>
                    ...
                    <div class="card-header">
                        <nav class="navbar bg-light">
                            <div class="container-fluid">
                                <a class="btn btn-primary" href="{{ route('roles.create') }}"> Agregar un
                                   Rol </a>
                            </div>
                        </nav>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <li><a href="{{route('roles.edit', $rol->id )}}"
                                                            class="dropdown-item active">Asginar permisos</a></li>
                                                    <li>
